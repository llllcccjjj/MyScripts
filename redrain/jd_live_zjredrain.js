/*
0,1 0,9,11,13,15,17,19-21,23 8-18 2 *
#宅家红包雨
============Quantumultx===============
[task_local]
#宅家红包雨
0,1 0,9,11,13,15,17,19-21,23 8-18 2 * https://raw.githubusercontent.com/mit-ywtm/MyScripts/main/redrain/jd_live_zjredrain.js, tag=宅家红包雨, enabled=true

================Loon==============
[Script]
cron "0,1 0,9,11,13,15,17,19-21,23 8-18 2 *" script-path=https://raw.githubusercontent.com/mit-ywtm/MyScripts/main/redrain/jd_live_zjredrain.js, tag=宅家红包雨

===============Surge=================
宅家红包雨 = type=cron,cronexp="0,1 0,9,11,13,15,17,19-21,23 8-18 2 *",wake-system=1,timeout=200,script-path=https://raw.githubusercontent.com/mit-ywtm/MyScripts/main/redrain/jd_live_zjredrain.js

============小火箭=========
宅家红包雨 = type=cron,script-path=https://raw.githubusercontent.com/mit-ywtm/MyScripts/main/redrain/jd_live_zjredrain.js, cronexpr="0,1 0,9,11,13,15,17,19-21,23 8-18 2 *", timeout=200, enable=true
*/
const $ = new Env('宅家红包雨');
...
function getRedRain() {
  let body = `body=%7B%22itemId%22%3Anull%2C%22liveId%22%3A%22`+livedetail.liveId+`%22%2C%22masterPin%22%3Anull%7D&`
  return new Promise(resolve => {
      ...
      try {
        if (err) {
          ...
          if (safeGet(data)) {
            ...
            // console.log(data.data.iconArea)
            if (data.data && data.data.iconArea) {
              ...
              if (act) {
                ...
                console.log(`\n下一场红包雨开始时间：${new Date(act.startTime)}`)
